...
# # mlflow.set_tacking_uri(f"{dagshub_url}/{repo_owner}/{repo_name}")
...
#     "app_request_count", 
#     "Total number of request to the app", 
#     ["method", "endpoint"], 
#     registry = registry
# )
...
#     "Count of prediction for each class",
#     ["prediction"],
#     registry = registry
# )
...
def predict():
    ...
    print("Original text given by user :", text)
